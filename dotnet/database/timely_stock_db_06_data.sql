...
INSERT INTO items(item_name, product_url, sku_item_number, price, available_quantity, reorder_point, reorder_quantity, category_id, supplier_id)
VALUES('Gain Detergent 1.44 Gallon', null, '30772080085', 17.99, 0, 1, 1, (SELECT category_id FROM categories WHERE category_name = 'Laundry'), (SELECT supplier_id from suppliers WHERE supplier_name = 'Amazon'));
